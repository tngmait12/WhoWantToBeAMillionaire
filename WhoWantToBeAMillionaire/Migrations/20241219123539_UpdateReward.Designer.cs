...
namespace WhoWantToBeAMillionaire.Migrations
{
    ...
    [Migration("20241219123539_UpdateReward")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WhoWantToBeAMillionaire.Models.AppUserModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WhoWantToBeAMillionaire.Models.HistoryModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WhoWantToBeAMillionaire.Models.AppUserModel", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WhoWantToBeAMillionaire.Models.HistoryModel", b =>
                {
                    ...
                    b.HasOne("WhoWantToBeAMillionaire.Models.AppUserModel", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("WhoWantToBeAMillionaire.Models.RoomModel", b =>
                {
                    b.HasOne("WhoWantToBeAMillionaire.Models.AppUserModel", "HostPlayer")
                        .WithMany()
